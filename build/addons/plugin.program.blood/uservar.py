...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]blood[/B][/COLOR]Wizard'
BUILDERNAME = 'blood'
...
BUILDFILE = 'https://petra1990.000webhostapp.com/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]blood[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing blood.\n\nContact us on at https://example.com/'
...
REPOADDONXML = 'https://petra1990.000webhostapp.com/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://petra1990.000webhostapp.com/zips/repository.blood'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]blood[/B][/COLOR]Wizard'
